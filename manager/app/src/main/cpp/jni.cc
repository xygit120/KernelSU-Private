...
Java_com_android_video_Natives_getVersion(JNIEnv *env, jobject) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_android_video_Natives_getKernelUAPIVersion(JNIEnv *env, jobject) {
    return get_kernel_uapi_version();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_android_video_Natives_getManagerUAPIVersion(JNIEnv *env, jobject) {
    return get_manager_uapi_version();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_android_video_Natives_getSuperuserCount(JNIEnv *env, jobject) {
...
Java_com_android_video_Natives_isSafeMode(JNIEnv *env, jclass clazz) {
    return is_safe_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_android_video_Natives_isLkmMode(JNIEnv *env, jclass clazz) {
    return is_lkm_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_android_video_Natives_isLateLoadMode(JNIEnv *env, jclass clazz) {
    return is_late_load_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_android_video_Natives_isManager(JNIEnv *env, jclass clazz) {
    return is_manager();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_android_video_Natives_isPrBuild(JNIEnv *env, jclass clazz) {
    return is_pr_build();
}
...
Java_com_android_video_Natives_getAppProfile(JNIEnv *env, jobject, jstring pkg, jint uid) {
    ...
    auto cls = env->FindClass("com/android/video/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_android_video_Natives_setAppProfile(JNIEnv *env, jobject clazz, jobject profile) {
    auto cls = env->FindClass("com/android/video/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_android_video_Natives_isSuEnabled(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_android_video_Natives_isSelinuxHideEnabled(JNIEnv *env, jobject thiz) {
    return is_selinux_hide_enabled();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_android_video_Natives_setSelinuxHideEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_selinux_hide_enabled(enabled);
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_android_video_Natives_getUserName(JNIEnv *env, jobject thiz, jint uid) {
...
Java_com_android_video_magica_AppZygotePreload_forkDontCareAndExecKsud(JNIEnv *env, jclass clazz,
